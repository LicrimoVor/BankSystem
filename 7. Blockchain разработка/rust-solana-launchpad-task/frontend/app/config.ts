...
export const ORACLE_PROGRAM_ID = "5tNEMPPJ9pUB3KMd91xmyNYJLGPQbGGXv6jd4AtWtAuJ";
export const MINTER_PROGRAM_ID = "H4hfeNfRGQEdvVQrZi4AgoXBfpDZBCNQdszNmVRAAbJT";
